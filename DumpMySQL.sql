...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 21 2022 г., 12:57
...
--
-- Очистить таблицу перед добавлением данных `c_pr_identity`
--

TRUNCATE TABLE `c_pr_identity`;
--
...
--
-- Очистить таблицу перед добавлением данных `main_product_category`
--

TRUNCATE TABLE `main_product_category`;
--
...
--
-- Очистить таблицу перед добавлением данных `pictures`
--
...
(17, 'top_white.jpg', 'Белый топ'),
(18, 'top_purple.jpg', 'Сиреневый топ'),
(19, 'top_mat-purple.jpg', 'Матово-сиреневый топ'),
...
--
-- Очистить таблицу перед добавлением данных `preview_picture_product`
--

TRUNCATE TABLE `preview_picture_product`;
--
...
--
-- Очистить таблицу перед добавлением данных `pr_pi_identity`
--

TRUNCATE TABLE `pr_pi_identity`;
--
...
--
ALTER TABLE `pictures`
  MODIFY `id_picture` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
